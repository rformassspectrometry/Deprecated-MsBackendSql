...
# Introduction
This vignette will briefly introduce the usage of new SQLite based backend 
`MsBackendSqlDb`. I will also compare `MsBackendSqlDb` to 
